...
# Quick config edits
abbr -a fish# Fish Shell Configuration
# ~/.config/fish/config.fish
# Modern, blazing-fast shell setup optimized for development
...
if command -q zoxide
    ...
    # Override cd with z for smart directory jumping
    abbr -a cd 'z'
end
...
if command -q fzf
    # FZF default options for beautiful interface
...
# ===== STARSHIP PROMPT =====
# Initialize Starship prompt (fast, beautiful, customizable)
...
# Reduce history size for faster searches
...
# Node.js (nvm.fish plugin)
# This is handled by the nvm.fish plugin - no manual setup needed!
...
# ===== ABBREVIATIONS (Fish's superior alternative to aliases) =====
# Abbreviations expand when you press space or enter - much better than aliases!
...
# Enable better completion caching
...
if status is-interactive
    ...
    echo "📚 Check out ~/.dotfiles/docs/FISH_GUIDE.md for advanced tips"
end
end
